...
void PrintDateUsingDayOrder(short Year, short TotalDays)
{
	...
	for (int i = 1; i <=12; i++)
	{
		DaysPerMonth[i - 1] = NumberOfDaysInAMonth(i, Year);
	}
...
int main()
{
	...
	printf("\n\nDate For [%d] Days is : ", NumOfDaysFromBegin);
	PrintDateUsingDayOrder(Year, NumOfDaysFromBegin);
